...
class SecCrawler():
    ...
    def filing_NCSR(self, company_code, cik, priorto, count):
        ...
        base_url = "https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=" + str(
            cik) + "&type=N-CSR&dateb=" + str(priorto) + "&owner=exclude&output=xml&count=" + str(count)
    ...
    def filing_NCSRS(self, company_code, cik, priorto, count):
        # generate the url to crawl
        base_url = "https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=" + str(
            cik) + "&type=N-CSRS&dateb=" + str(priorto) + "&owner=exclude&output=xml&count=" + str(count)
    ...
    def filing_NQ(self, company_code, cik, priorto, count):
        # generate the url to crawl
        base_url = "https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=" + str(
            cik) + "&type=N-Q&dateb=" + str(priorto) + "&owner=exclude&output=xml&count=" + str(count)
